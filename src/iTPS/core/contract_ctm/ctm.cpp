...
typename tensor::value_type Contract_one_site_density(
  ...
  return trace(
	  ...
	  Tn1, tensordot(
	      tensordot(
		  eT1, tensordot(
		      C1, eT4, Axes(0), Axes(1)
		  ), Axes(0), Axes(0)
	      ), tensordot(
		  tensordot(
		      C2, eT2, Axes(1), Axes(0)
		  ), tensordot(
		      C3, tensordot(
			  C4, eT3, Axes(0), Axes(1)
		      ), Axes(1), Axes(1)
		  ), Axes(1), Axes(0)
	      ), Axes(0, 2), Axes(0, 2)
...
typename tensor::value_type Contract_two_sites_horizontal_density(
  ...
  return trace(
	  ...
	  Tn1, tensordot(
	      tensordot(
		  eT1, tensordot(
		      C1, eT6, Axes(0), Axes(1)
		  ), Axes(0), Axes(0)
	      ), tensordot(
		  tensordot(
		      C4, eT5, Axes(0), Axes(1)
		  ), tensordot(
		      eT2, tensordot(
			  tensordot(
			      Tn2, op2, Axes(4, 5), Axes(0, 1)
			  ), tensordot(
			      eT4, tensordot(
				  C2, tensordot(
				      C3, eT3, Axes(0), Axes(1)
				  ), Axes(1), Axes(1)
			      ), Axes(0), Axes(1)
			  ), Axes(2, 3), Axes(3, 1)
		      ), Axes(1, 2), Axes(3, 1)
