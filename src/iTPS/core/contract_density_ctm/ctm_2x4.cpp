...
typename tensor::value_type Contract_2x4_density_CTM(
  ...
  // 2_4_den.dat
  ////////////////////////////////////////////////////////////
  // (*(op[0][0])*(*(Tn[0][0])*((*(eTt[0])*(*(C[0])**(eTl[0])))*(((*(Tn[1][0])**(op[1][0]))*(*(eTb[0])*(*(C[3])**(eTl[1]))))*(*(eTt[1])*((*(Tn[0][1])**(op[0][1]))*((*(Tn[1][1])**(op[1][1]))*(*(eTb[1])*(*(eTt[2])*((*(Tn[0][2])**(op[0][2]))*((*(Tn[1][2])**(op[1][2]))*(*(eTb[2])*(((*(Tn[0][3])**(op[0][3]))*(*(eTt[3])*(*(C[1])**(eTr[0]))))*((*(Tn[1][3])**(op[1][3]))*(*(eTr[1])*(*(C[2])**(eTb[3])))))))))))))))))
...
//! @cond
INSTANTIATE_CONTRACT_DENSITY(real_tensor, 2, 4);
INSTANTIATE_CONTRACT_DENSITY(complex_tensor, 2, 4);
//! @endcond
