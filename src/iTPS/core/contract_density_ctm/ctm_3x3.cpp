...
typename tensor::value_type Contract_3x3_density_CTM(
  ...
  // 3_3_den.dat
  ////////////////////////////////////////////////////////////
  // (*(op[0][0])*(*(Tn[0][0])*((*(eTt[0])*(*(C[0])**(eTl[0])))*(*(eTt[1])*((*(Tn[0][1])**(op[0][1]))*(((*(Tn[0][2])**(op[0][2]))*(*(eTt[2])*(*(C[1])**(eTr[0]))))*(*(eTr[1])*((*(Tn[1][2])**(op[1][2]))*((*(Tn[1][1])**(op[1][1]))*((*(Tn[1][0])**(op[1][0]))*(*(eTl[1])*(((*(Tn[2][0])**(op[2][0]))*(*(eTb[0])*(*(C[3])**(eTl[2]))))*((*(Tn[2][1])**(op[2][1]))*(*(eTb[1])*((*(Tn[2][2])**(op[2][2]))*(*(eTr[2])*(*(C[2])**(eTb[2]))))))))))))))))))
  // cpu_cost= 9.01531e+06  memory= 160336
  // final_bond_order ()
  ////////////////////////////////////////////////////////////
  return trace(
      *(op[0][0]),
...
//! @cond
INSTANTIATE_CONTRACT_DENSITY(real_tensor, 3, 3);
INSTANTIATE_CONTRACT_DENSITY(complex_tensor, 3, 3);
//! @endcond
