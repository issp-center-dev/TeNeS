...
typename tensor::value_type Contract_3x4_density_CTM(
  ...
  // 3_4_den.dat
  ////////////////////////////////////////////////////////////
  // (*(op[0][0])*(*(Tn[0][0])*((*(eTt[0])*(*(C[0])**(eTl[0])))*(*(eTl[1])*((*(Tn[1][0])**(op[1][0]))*(((*(Tn[2][0])**(op[2][0]))*(*(eTb[0])*(*(C[3])**(eTl[2]))))*(*(eTt[1])*((*(Tn[0][1])**(op[0][1]))*((*(Tn[1][1])**(op[1][1]))*((*(Tn[2][1])**(op[2][1]))*(*(eTb[1])*(*(eTt[2])*((*(Tn[0][2])**(op[0][2]))*((*(Tn[1][2])**(op[1][2]))*((*(Tn[2][2])**(op[2][2]))*(*(eTb[2])*(((*(Tn[0][3])**(op[0][3]))*(*(eTt[3])*(*(C[1])**(eTr[0]))))*((*(Tn[1][3])**(op[1][3]))*(*(eTr[1])*((*(Tn[2][3])**(op[2][3]))*(*(eTr[2])*(*(C[2])**(eTb[3])))))))))))))))))))))))
  // cpu_cost= 1.42705e+07  memory= 174720
  // final_bond_order ()
  ////////////////////////////////////////////////////////////
  return trace(
      *(op[0][0]),
                  ...
                  *(eTl[1]),
                  tensordot(
                      tensordot(*(Tn[1][0]), *(op[1][0]), Axes(4, 5),
                                Axes(0, 1)),
                      tensordot(
                          tensordot(tensordot(*(Tn[2][0]), *(op[2][0]),
                                              Axes(4, 5), Axes(0, 1)),
                                    tensordot(*(eTb[0]),
                                              tensordot(*(C[3]), *(eTl[2]),
                                                        Axes(1), Axes(0)),
                          ...
                          tensordot(
                              *(eTt[1]),
                              tensordot(
                                  tensordot(*(Tn[0][1]), *(op[0][1]),
                                            Axes(4, 5),
                                            Axes(0, 1)),
                                  tensordot(
                                      tensordot(
                                          *(Tn[1][1]), *(op[1][1]), Axes(4, 5),
                                          Axes(0, 1)),
                                      tensordot(
                                          tensordot(
                                              *(Tn[2][1]), *(op[2][1]),
...
//! @cond
INSTANTIATE_CONTRACT_DENSITY(real_tensor, 3, 4);
INSTANTIATE_CONTRACT_DENSITY(complex_tensor, 3, 4);
//! @endcond
