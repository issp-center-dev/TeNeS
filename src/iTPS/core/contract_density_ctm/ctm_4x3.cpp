...
typename tensor::value_type Contract_4x3_density_CTM(
  ...
  // 4_3_den.dat
  ////////////////////////////////////////////////////////////
  // (*(op[0][0])*(*(Tn[0][0])*((*(eTt[0])*(*(C[0])**(eTl[0])))*(*(eTt[1])*((*(Tn[0][1])**(op[0][1]))*(((*(Tn[0][2])**(op[0][2]))*(*(eTt[2])*(*(C[1])**(eTr[0]))))*(*(eTr[1])*((*(Tn[1][2])**(op[1][2]))*((*(Tn[1][1])**(op[1][1]))*((*(Tn[1][0])**(op[1][0]))*(*(eTl[1])*(*(eTr[2])*((*(Tn[2][2])**(op[2][2]))*((*(Tn[2][1])**(op[2][1]))*((*(Tn[2][0])**(op[2][0]))*(*(eTl[2])*(((*(Tn[3][0])**(op[3][0]))*(*(eTb[0])*(*(C[3])**(eTl[3]))))*((*(Tn[3][1])**(op[3][1]))*(*(eTb[1])*((*(Tn[3][2])**(op[3][2]))*(*(eTr[3])*(*(C[2])**(eTb[2])))))))))))))))))))))))
                  ...
                  *(eTt[1]),
                  tensordot(
                      tensordot(*(Tn[0][1]), *(op[0][1]), Axes(4, 5),
                                Axes(0, 1)),
                      tensordot(
                          tensordot(tensordot(*(Tn[0][2]), *(op[0][2]),
                                              Axes(4, 5), Axes(0, 1)),
                                    tensordot(*(eTt[2]),
                                              tensordot(*(C[1]), *(eTr[0]),
                                                        Axes(1), Axes(0)),
...
//! @cond
INSTANTIATE_CONTRACT_DENSITY(real_tensor, 4, 3);
INSTANTIATE_CONTRACT_DENSITY(complex_tensor, 4, 3);
//! @endcond
