...
#ifndef INSTANTIATE_CONTRACT_DENSITY
#define INSTANTIATE_CONTRACT_DENSITY(tensor_type, NROW, NCOL)              \
  template tensor_type::value_type Contract_##NROW##x##NCOL##_density_CTM( \
