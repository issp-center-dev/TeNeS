...
template void StartCorrelation_iTPS_CTM(
...
template void Transfer_iTPS_CTM(real_tensor &A, const real_tensor &eT1,
                                const real_tensor &eT3, const real_tensor &Tn1);
template void Transfer_iTPS_CTM(complex_tensor &A, const complex_tensor &eT1,
                                const complex_tensor &eT3,
                                const complex_tensor &Tn1);

template typename real_tensor::value_type FinishCorrelation_iTPS_CTM(
    ...
    const real_tensor &Tn1, const real_tensor &op);
template typename complex_tensor::value_type FinishCorrelation_iTPS_CTM(
