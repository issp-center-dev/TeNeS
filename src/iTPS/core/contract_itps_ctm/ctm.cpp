...
typename tensor::value_type Contract_iTPS_CTM(
...
#define CALL_CONTRACT(NROW, NCOL)                                           \
  do {                                                                      \
    if (nrow == NROW && ncol == NCOL) {                                     \
      return Contract_##NROW##x##NCOL##_iTPS_CTM(C, eTt, eTr, eTb, eTl, Tn, \
                                                 op);                       \
    }                                                                       \
  } while (false)
...
#undef CALL_CONTRACT
  ...
  std::stringstream ss;
  ss << "Contract_" << nrow << "_" << ncol << "_iTPS_CTM is not implemented";
...
template <class tensor>
typename tensor::value_type Contract_two_sites_vertical_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op1, const tensor &op2) {
...
template <class tensor>
typename tensor::value_type Contract_two_sites_horizontal_op12_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op12) {
...
template <class tensor>
typename tensor::value_type Contract_two_sites_vertical_op12_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op12) {
...
template <class tensor>
typename tensor::value_type Contract_four_sites_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
...
template <class tensor>
typename tensor::value_type Contract_one_site_density_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &Tn1, const tensor &op1) {
  ////////////////////////////////////////////////////////////
...
template <class tensor>
typename tensor::value_type Contract_two_sites_horizontal_density_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op1, const tensor &op2) {
...
template <class tensor>
typename tensor::value_type Contract_two_sites_vertical_density_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op1, const tensor &op2) {
...
template <class tensor>
typename tensor::value_type Contract_two_sites_horizontal_op12_density_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op12) {
...
template <class tensor>
typename tensor::value_type Contract_two_sites_vertical_op12_density_iTPS_CTM(
    const tensor &C1, const tensor &C2, const tensor &C3, const tensor &C4,
    const tensor &eT1, const tensor &eT2, const tensor &eT3, const tensor &eT4,
    const tensor &eT5, const tensor &eT6, const tensor &Tn1, const tensor &Tn2,
    const tensor &op12) {
