...
#ifndef INSTANTIATE_CONTRACT_ITPS_CTM
#define INSTANTIATE_CONTRACT_ITPS_CTM(tensor_type, NROW, NCOL)          \
  template tensor_type::value_type Contract_##NROW##x##NCOL##_iTPS_CTM( \
