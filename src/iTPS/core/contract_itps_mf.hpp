...
#ifndef TENES_SRC_ITPS_CORE_CONTRACT_ITPS_iTPS_MF_HPP_
#define TENES_SRC_ITPS_CORE_CONTRACT_ITPS_iTPS_MF_HPP_
...
typename tensor::value_type Contract_iTPS_MF(
...
template <class tensor>
typename tensor::value_type Contract_two_sites_horizontal_iTPS_MF(
    const tensor &Tn_0_0, const tensor &Tn_0_1, const tensor &op_0_0,
    const tensor &op_0_1);

template <class tensor>
typename tensor::value_type Contract_two_sites_horizontal_op12_iTPS_MF(
    const tensor &Tn_0_0, const tensor &Tn_0_1, const tensor &op12);

template <class tensor>
typename tensor::value_type Contract_two_sites_vertical_op12_iTPS_MF(
    const tensor &Tn_0_0, const tensor &Tn_1_0, const tensor &op12);

template <class tensor>
typename tensor::value_type Contract_four_sites_iTPS_MF(
...
#define DECLARE_CONTRACT(NROW, NCOL)                            \
  template <class tensor>                                       \
  typename tensor::value_type Contract_##NROW##x##NCOL##_iTPS_MF( \
      const std::vector<std::vector<const tensor *>> &Tn,       \
      const std::vector<std::vector<const tensor *>> &op)
