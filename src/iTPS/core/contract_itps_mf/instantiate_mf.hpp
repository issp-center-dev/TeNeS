...
template TENSOR_TYPE::value_type Contract_iTPS_MF(
...
template TENSOR_TYPE::value_type Contract_two_sites_horizontal_iTPS_MF(
    const TENSOR_TYPE &Tn_0_0, const TENSOR_TYPE &Tn_0_1,
    const TENSOR_TYPE &op_0_0, const TENSOR_TYPE &op_0_1);

template TENSOR_TYPE::value_type Contract_two_sites_horizontal_op12_iTPS_MF(
    const TENSOR_TYPE &Tn_0_0, const TENSOR_TYPE &Tn_0_1,
...
template TENSOR_TYPE::value_type Contract_four_sites_iTPS_MF(
    const TENSOR_TYPE &Tn_0_0, const TENSOR_TYPE &Tn_0_1,
